  ...
  const response = await queue({
    ...
    postProcess: {
      ...
      ["text/html"]: async ({
        ...
        // $("#footer-info").remove(); // remove footer «Diese Seite wurde zuletzt am 19. August 2023 um 21:45 Uhr bearbeitet.»
        ...
        $("#n-help-mediawiki").remove(); // remove «Hilfe zu MediaWiki»
        ...
        $("#mw-head .vector-menu-content").remove(); // remove «Nicht angemeldet | Diskussionsseite | Beiträge | Benutzerkonto erstellen | Anmelden»
